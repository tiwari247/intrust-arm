Param($DomainFullName,$CM,$CMUser,$INTRName,$ClientName)
...
. $ScriptFile $DomainFullName $INTRName $Role $ProvisionToolPath
...
#. $ScriptFile $DomainFullName $CMUser $ClientName $INTRName $Role $ProvisionToolPath